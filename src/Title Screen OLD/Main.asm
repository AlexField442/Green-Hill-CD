...
; -------------------------------------------------------------------------
	...
	include	"Title Screen OLD/_Common.inc"
...
.Palette:
	incbin	"Title Screen OLD/Data/Palette (Initialization).bin"
.PaletteEnd:
	even
...
Pal_Title:
	incbin	"Title Screen OLD/Data/Palette.bin"
	even
...
; -------------------------------------------------------------------------
	...
	include	"Title Screen OLD/Objects/Sonic/Main.asm"
	include	"Title Screen OLD/Objects/Banner/Main.asm"
	include	"Title Screen OLD/Objects/Planet/Main.asm"
	include	"Title Screen OLD/Objects/Menu/Main.asm"
	include	"Title Screen OLD/Objects/Copyright/Main.asm"
...
Map_Water:
	incbin	"Title Screen OLD/Data/Water Mappings.bin"
	even

Map_Mountains:
	incbin	"Title Screen OLD/Data/Moutains Mappings.bin"
	even

Map_Emblem:
	incbin	"Title Screen OLD/Data/Emblem Mappings.bin"
	even

Art_Water:
	incbin	"Title Screen OLD/Data/Water Art.nem"
	even

Art_Mountains:
	incbin	"Title Screen OLD/Data/Moutains Art.nem"
	even

Art_Emblem:
	incbin	"Title Screen OLD/Data/Emblem Art.nem"
	even

Art_Banner:
	incbin	"Title Screen OLD/Objects/Banner/Data/Art.nem"
	even

Art_Planet:
	incbin	"Title Screen OLD/Objects/Planet/Data/Art.nem"
	even

Art_Sonic:
	incbin	"Title Screen OLD/Objects/Sonic/Data/Art.nem"
	even

Art_SolidColor:
	incbin	"Title Screen OLD/Data/Solid Color Art.nem"
	even

Art_NewGameText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, New Game).nem"
	even

Art_ContinueText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, Continue).nem"
	even

Art_TimeAttackText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, Time Attack).nem"
	even

Art_RamDataText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, RAM Data).nem"
	even

Art_DAGardenText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, D.A. Garden).nem"
	even

Art_VisualModeText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, Visual Mode).nem"
	even

Art_PressStartText:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Text, Press Start).nem"
	even

Art_MenuArrow:
	incbin	"Title Screen OLD/Objects/Menu/Data/Art (Arrow).nem"
	even

Art_Copyright:
	incbin	"Title Screen OLD/Objects/Copyright/Data/Art (Copyright, JPN and EUR).nem"
	even

	if REGION=USA
Art_TM:
		incbin	"Title Screen OLD/Objects/Copyright/Data/Art (TM, USA).nem"
		even

Art_CopyrightTM:
		incbin	"Title Screen OLD/Objects/Copyright/Data/Art (Copyright, USA).nem"
		even
	else
Art_TM:
		incbin	"Title Screen OLD/Objects/Copyright/Data/Art (TM, JPN and EUR).nem"
		even
	endif
