...
MapSpr_Copyright:
	if REGION=USA
		include	"Title Screen OLD/Objects/Copyright/Data/Mappings (Copyright, USA).asm"
	else
		include	"Title Screen OLD/Objects/Copyright/Data/Mappings (Copyright, JPN and EUR).asm"
	endif
	even
...
MapSpr_TM:
	include	"Title Screen OLD/Objects/Copyright/Data/Mappings (TM).asm"
	even
