...
LevelStartLoc:
	incbin	"Level/Palmtree Panic/Data/Start Position (Act 3 Present).bin"
...
InitLevelScroll:
	tst.b	spawnMode			; Is the player being spawned at the beginning?
	bne.s	.DefaultStart			; If so, branch
...
; -------------------------------------------------------------------------
	...
	lea	hscroll.w,a1		; Prepare deformation buffer
	move.w	cameraY.w,d0
	andi.w	#$7FF,d0
	lsr.w	#5,d0
	neg.w	d0
